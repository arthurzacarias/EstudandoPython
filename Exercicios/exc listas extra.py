...
'''
produto = input("Insira o novo produto que quer cadastrar").lower()
produtos = ["celular", "camera", "fone de ouvido", "monitor"]

if produto in produtos:
    print("Produto já existente na lista, tente novamente")
else:
    produtos.append(produto)
    print("Produto: {}, cadastrado na lista".format(produto))
    print(produtos)
...
'''
produto = input("Insira o produto que deseja consultar o preço").lower()
...
if produto in produtos:
    ...
    valor_produto = precos[i]
    print("O valor do produto {} é: R${:,}".format(produto, valor_produto))
else:
    print("Produto não existente na lista, tente novamente")
...
'''
qnt_vendas = float(input("Digite aqui a quantidade de vendas: (apenas números)"))
if qnt_vendas >= 5000:
    bonus = qnt_vendas * 2 + 1000
elif qnt_vendas >= 1000:
    bonus = qnt_vendas * 2
else:
    bonus = 0

print("O total de bonús por {} vendas é: R${:,}".format(qnt_vendas, bonus))
'''
# Exercício 4
...
if vendas1 > vendas2:
    print("O vendedor número 1 foi o melhor")
else:
    print("O vendedor número 2 foi o melhor")
